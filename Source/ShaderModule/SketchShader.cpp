...
IMPLEMENT_SHADER_TYPE(, FSketchShaderVS, TEXT("/Engine/Private/SketchShader.usf"), TEXT("MainVS"), SF_Vertex);
IMPLEMENT_SHADER_TYPE(, FSketchShaderPS, TEXT("/Engine/Private/SketchShader.usf"), TEXT("MainPS"), SF_Pixel);
